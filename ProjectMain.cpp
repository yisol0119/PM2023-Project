...
void initialize() {
	...
	Platform ground(0.0f, -boundaryY + PLAYER_SIZE * 0.5f, 0.0f, boundaryX * 2, PLAYER_SIZE/4, Platform::IMPASSABLE);
	Platform platform1(0.0f, -boundaryY + PLAYER_SIZE * 0.5f+100, 0.0f, boundaryX, PLAYER_SIZE/4, Platform::IMPASSABLE);
	Platform platform2(0.0f, -boundaryY + PLAYER_SIZE * 0.5f + 200, 0.0f, boundaryX, PLAYER_SIZE/4, Platform::ISPASSABLE);
	Wall wall1(-boundaryX, 0, 0.0f, PLAYER_SIZE, 2*boundaryY);
	Wall wall2(+boundaryX, 0, 0.0f, PLAYER_SIZE, 2 *boundaryY);
	...
	stage_1.setWall(wall1);
	stage_1.setWall(wall2);
